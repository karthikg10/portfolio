      ...
      <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border border-gray-300 dark:border-white/10 rounded-2xl overflow-hidden flex flex-col" style={{ maxHeight: 'calc(100vh - 200px)' }}>
        ...
        <div className="bg-gray-100/90 dark:bg-gray-800/90 px-2.5 py-1.5 sm:px-4 sm:py-3 flex items-center justify-between border-b border-gray-300 dark:border-white/10 cursor-move">
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <button
              onClick={onClose}
              className="w-[6px] h-[6px] sm:w-3 sm:h-3 rounded-full bg-red-500 hover:bg-red-600 transition-colors flex items-center justify-center group"
              aria-label="Close"
            >
              <FaTimes className="text-white text-[2px] sm:text-[6px] opacity-0 group-hover:opacity-100 transition-opacity" />
            </button>
            <button
              onClick={onClose}
              className="w-[6px] h-[6px] sm:w-3 sm:h-3 rounded-full bg-yellow-500 hover:bg-yellow-600 transition-colors flex items-center justify-center group"
              aria-label="Close"
            >
              <FaMinus className="text-yellow-900 text-[2px] sm:text-[6px] opacity-0 group-hover:opacity-100 transition-opacity" />
            </button>
            <button
              onClick={() => setIsMaximized(!isMaximized)}
              className="w-[6px] h-[6px] sm:w-3 sm:h-3 rounded-full bg-green-500 hover:bg-green-600 transition-colors flex items-center justify-center group"
              aria-label="Maximize"
            >
              <FaWindowMaximize className="text-white text-[2px] sm:text-[5px] opacity-0 group-hover:opacity-100 transition-opacity" />
            </button>
          </div>
